...
`Phoenix models README file <http://www.stsci.edu/hst/instrumentation
/reference-data-for-calibration-and-tools/astronomical-catalogs/phoenix-models-a
vailable-in-pysynphot>`_
for more details.
The atlas data files are organized in a similar naming convention as
:ref:`stsynphot-appendixa-kurucz1993`, and are easily accessible using
