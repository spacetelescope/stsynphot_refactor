...
|Atlas/Catalog                        |Installation Path              |Interpolatable|
+=====================================+===============================+==============+
|:ref:`stsynphot-appendixa-phoenix`   |$PYSYN_CDBS/grid/phoenix       |Yes           |
+-------------------------------------+-------------------------------+--------------+
...
`~stsynphot.catalog.Icat` (also see :ref:`stsynphot-spec-atlas`).
...
:ref:`renormalized <stsynphot-renorm>` appropriately.
...
The easier way to to use `~stsynphot.catalog.Icat` (also see
...
:ref:`renormalized <stsynphot-renorm>` to their appropriate absolute levels.
